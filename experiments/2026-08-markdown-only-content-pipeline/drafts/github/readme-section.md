...
**Question:** Can a content pipeline run on Markdown conventions and Claude Code skills — no n8n, Coze, Dify, server, or database?
...
**Publishing status:** account setup and maintenance, real screenshots, author sign-off, mobile preview, layout, publishing, and comment handling have not been executed or verified. The zero recordings also mean the YouTube package is not a producible video.
